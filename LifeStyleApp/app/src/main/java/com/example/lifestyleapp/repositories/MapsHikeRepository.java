...
import com.example.lifestyleapp.ui.mapHikes.Trail;
...
public class MapsHikeRepository {
    double lat;
    double lon;
    ...
    public MapsHikeRepository(@NonNull Application application) throws IOException, JSONException {
        threadCompleted = new MutableLiveData<>();
    }

    @SuppressLint("StaticFieldLeak")
  public void setUserLocation(Location location) throws IOException, JSONException {
